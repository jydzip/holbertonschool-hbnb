class Places:
    ...
    def __str__(self) -> str:
        return (f"[Place] {self.id} _ {self.name} /\ {self.adress} /\ 
                {self.city_id} /\ {self.host_id} /\ {self.number_of_rooms} /\ 
                {self.number_of_bathrooms} /\ {self.price_per_night} /\ 
                {self.max_guests} /\ {self.amenity_ids}")
